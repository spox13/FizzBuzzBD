...
namespace FizzBuzzBD.Pages
{
    public class IndexModel : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            ...
            else if (!String.IsNullOrEmpty(FizzBuzz.Name) && !String.IsNullOrEmpty(FizzBuzz.Year.ToString()) && FizzBuzz.Year >= 1899 && FizzBuzz.Year <= 2022)
            {
